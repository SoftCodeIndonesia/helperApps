        ...
        <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input type="hidden" class="form-control" id="id_bantuan" value="<?= $data['penerima']['id_kategori_bantuan'] ?>" name="id_bantuan" placeholder="Pilih jenis bantuan" >


                        <input type="text" class="form-control input-modal" id="jenis_bantuan" name="bantuan" placeholder="Pilih jenis bantuan" value="<?= $data['penerima']['jenis_bantuan'] ?>" data-modal="bantuan" readonly data-toggle="modal" required>

                        <p class="text-danger font-italic" id="alert-jenis-bantuan"></p>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="periode">Periode</label>
                        <input type="text" class="form-control input-modal" id="periode" name="periode" placeholder="periode bantuan" value="<?= date('d M Y',$data['penerima']['periode']) ?>" data-modal="bantuan" readonly>
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input type="hidden" class="form-control" value="<?= $data['id_keluarga'] ?>" id="id_keluarga" name="id_keluarga" placeholder="Pilih jenis bantuan">

                        <input type="text" class="form-control input-modal" value="<?= $data['penerima']['no_kk'] ?>" id="no_kk" name="no_kk" placeholder="pilih No KK" data-modal="penduduk" readonly required>

                        <p class="text-danger font-italic" id="alert-nokk"></p>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="keluarga">Keluarga</label>
                        <input type="text" class="form-control input-modal" name="keluarga" id="keluarga" placeholder="periode bantuan" value="<?= $data['penerima']['kepala_keluarga'] ?>" data-modal="penduduk" readonly required>
